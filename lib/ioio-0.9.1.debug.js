...
(function() {
  ...
  (function($) {
    return $.fn.arrowscrollers = function(options) {
      var debug, settings;
      settings = $.extend({
        classNames: {
      ...
      return this.each(function() {
        ...
        arrowRight = $("<div class=\"" + settings.classNames.arrowscroller + " " + settings.classNames.arrow + " " + settings.classNames.right + "\"></div>").css('width', settings.arrow.width).css('height', height).css('margin-left', width + margin).css('margin-top', -height).css('cursor', 'pointer').click(doScrollLeft);
        return element.css('margin-left', margin).css('margin-top', -height).before(arrowLeft).after(arrowRight);
      });
    };
  })(jQuery);
    ...
    methods = {
      ...
      resize: function(settings) {
        return this.each(function(index, item) {
          ...
          return element.trigger("fillify.fillify");
        });
      },
  ...
  (function($) {
    return $.fn.playertools = function(player, options) {
      var debug, playertools, settings;
      if (false === ((debug = window.debug) != null)) {
        debug = {
          log: function() {}
        };
      ...
      playertools = {
        isFlash: function(element) {
          return "OBJECT" === element.get(0).tagName;
        },
      ...
      return this.each(function() {
        ...
        playButton = $("<div class=\"button play\"></div>").appendTo(toolbar).click(function() {
          return playertools.playPause(player);
        });
        ...
        updateProgress = function(event) {
          ...
          return _this.updateProgressTimeout = setTimeout(function() {
            ...
            return _this.updateProgressTimeout = null;
          }, 500);
        };
