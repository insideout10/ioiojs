...
(function() {
  ...
  (function($) {
    ...
    methods = {
      init: function(options) {
        return this.each(function(index, item) {
          var $container, $scrollbar, $scroller, containment, scrollLeft, scrollbar, scroller, scrollerLeft, x1, x2, y1, y2;
          $container = $(item);
          ...
          scrollerLeft = function(container, scroller) {
            var scrollLeftRatio, scrollMaxLeft, scrollerMaxLeft;
          ...
          return $container.scroll(function(event) {
            ...
            $scrollbar.css('left', $container.scrollLeft());
            return $scroller.css('left', scrollerLeft($container, $scroller));
          });
        });
      }
    };
