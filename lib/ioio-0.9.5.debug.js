    ...
    methods = {
      ...
      log: function() {
        return this.each(function(index, item) {
          ...
          console.log("will log [position :: " + position + "][WebTrends :: " + (typeof Webtrends !== "undefined" && Webtrends !== null) + "]", settings.webtrends);
      ...
      init: function(options) {
        return this.each(function(index, item) {
          ...
          scroller.draggable({
            ...
            containment: "parent",
            drag: function(event, ui) {
              return container.scrollTop((container.get(0).scrollHeight - container.height()) * (ui.position.top / (container.height() - scroller.height())));
            },
            start: function() {
